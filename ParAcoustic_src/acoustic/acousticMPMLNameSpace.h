 ...
 */
#ifndef _ACOUSTIC_MPML_NS
#define _ACOUSTIC_MPML_NS

#include<math.h>

#include<stdio.h>

namespace acoustic_MPML {
...
extern float *__restrict__ bxZ0TaperPH;
  ...
  inline void updateAcousticPressurePML(float *__restrict__  vx,float *__restrict__  vy,float *__restrict__  vz, 
    ...
    for(int i=i0;i<ie;i++) {
      ...
      updateAcousticPressurePMLCore(vx,vy,vz,vxx,vyy,vzz,bulk,NX,NXY,cx0,cx1,cy0,cy1,cz0,cz1,dcx0,dcy0,dcz0,ssfunc,index,pIndex,i,pressure,axtaper,aytaper,aztaper,bxtaper,bytaper,bztaper,kxTaper[i],kytaper,kztaper);
    }
  }
  ...
  inline void updateAcousticPressurePML(float *__restrict__  vx,float *__restrict__  vy,float *__restrict__  vz, 
    ...
    for(int i=i0;i<ie;i++) {
      ...
      int index = i+jkind;
      int pIndex = i+jkpIndex;
      updateAcousticPressurePMLCore(vx,vy,vz,vxx,vyy,vzz,bulk,NX,NXY,cx0,cx1,cy0,cy1,cz0,cz1,dcx0,dcy0,dcz0,ssfunc,index,pIndex,i,pressure,axtaper[ti],aytaper[ti],aztaper[ti],bxtaper[ti],bytaper[ti],bztaper[ti],kxTaper[i],kytaper,kztaper);
    }
  }
  ...
  inline void updateAcousticPressurePMLO2(float *__restrict__  vx,float *__restrict__  vy,float *__restrict__  vz, 
    ...
    for(int i=i0;i<ie;i++) {
      int index = i+jkind;
      int pIndex = i+jkpIndex;
      updateAcousticPressurePMLCoreO2(vx,vy,vz,vxx,vyy,vzz,bulk,NX,NXY,dcx0,dcy0,dcz0,index,pIndex,i,pressure,axtaper,aytaper,aztaper,bxtaper,bytaper,bztaper,kxTaper[i],kytaper,kztaper);
    }
  }
  ...
  inline void updateAcousticPressurePMLO2(float *__restrict__  vx,float *__restrict__  vy,float *__restrict__  vz, 
    ...
    for(int i=i0;i<ie;i++) {
      ...
      int index = i+jkind;
      int pIndex = i+jkpIndex;
      updateAcousticPressurePMLCoreO2(vx,vy,vz,vxx,vyy,vzz,bulk,NX,NXY,dcx0,dcy0,dcz0,index,pIndex,i,pressure,axtaper[ti],aytaper[ti],aztaper[ti],bxtaper[ti],bytaper[ti],bztaper[ti],kxTaper[i],kytaper,kztaper);
    }
  }
